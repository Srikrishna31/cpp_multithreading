...
class Arguments:
    ...
    def with_validation(self: Self) -> Self:
        self.arguments['validation'] = True
        return self
...
class SymbolChecker:
    ...
    def print_errors(diagnostics) -> None:
        for error in diagnostics:
            ...
            print(f"Categeory: {error.category_name}")
            print("-" * 40)

def check_symbols(arguments: argparse.Namespace) -> None:
    checker = SymbolChecker(arguments.manifest_file, arguments.validation_file, arguments.workspace_path_file)
    checker.validate()
